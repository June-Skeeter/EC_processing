...
rootPath = os.path.abspath(os.path.join(os.path.dirname(__file__), 'outputs','testProject'))
...
ecf32(rootPath=rootPath,siteID='SCL',dataSourceID='EC_2024',verbose=False,fileName=os.path.join(data,'Flux_Data1426.dat'))

ecf32(rootPath=rootPath,siteID='SCL',dataSourceID='EC_2025',verbose=False,fileName=os.path.join(data,'57840_Time_Series_40.dat'))
